...
2. Чому не Helm Chart (Bitnami) для простих випадків, Helm Chart від Bitnami включає понад 50 параметрів і безліч додаткових функцій:
...
3. Коли варто використовувати Helm, Helm доцільний у production-середовищі, коли потрібні:
